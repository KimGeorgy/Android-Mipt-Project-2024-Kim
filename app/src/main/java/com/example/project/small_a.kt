...
class SmallA : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_small_a, container, false)
        ...
        buttonSearch.setOnClickListener {
            listener.searchRecipe(textField.editText?.text.toString())
        }
